...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-slate-800 px-4 transition-colors duration-300">
    <div class="card w-full max-w-md bg-white dark:bg-slate-900 shadow-xl">
      <div class="card-body">
        <h2 class="card-title text-3xl font-bold justify-center mb-6 text-gray-900 dark:text-white">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div v-if="!isLogin" class="form-control">
            <label class="label">
              <span class="label-text text-gray-700 dark:text-gray-300">Username</span>
            </label>
            <input
              v-model="username"
              type="text"
              placeholder="Enter your username"
              class="input input-bordered w-full bg-white dark:bg-slate-800 text-gray-900 dark:text-white border-gray-300 dark:border-slate-600"
              required
            />
          </div>
          ...
          <div class="form-control">
            <label class="label">
              <span class="label-text text-gray-700 dark:text-gray-300">Password</span>
            </label>
            <input
              v-model="password"
              type="password"
            ...
            <label v-if="isLogin" class="label">
              <a href="#" class="label-text-alt link link-hover text-gray-600 dark:text-gray-400">Forgot password?</a>
            </label>
          </div>
        ...
        <!-- Divider -->
        <div class="divider text-gray-600 dark:text-gray-400">OR</div>

        <!-- Social Login Buttons -->
        <div class="space-y-2">
          <button class="btn btn-outline w-full gap-2 border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800">
